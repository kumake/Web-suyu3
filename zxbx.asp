	...
	<tr>
		...
		<table id="__01" width="716" height="667" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<div style="padding-top:22px; margin-left:30px; font-size:14px; font-weight:bold;color:#fff;">在线报修</div>
				</td>
			</tr>
			<tr>
				...
				<div id="neiye_main">
								...
								<!--内容开始 -->
									<div style="margin-left:0px; margin-top:20px; line-height:30px;">
												<%
									''''''''''''''''
									''以下代码必须包含
									''''''''''''''''
