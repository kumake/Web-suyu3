	...
	<tr>
		...
		<table id="__01" width="716" height="667" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<div style="padding-top:22px; margin-left:30px; font-size:14px; font-weight:bold;color:#fff;">维修常识</div>
				</td>
			</tr>
			<tr>
				...
				<div id="neiye_main">
								<!--内容开始 -->
											  <%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_wxcs"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_wxcs where ID="&ItemID&"")
														UIcon.execute("update user_wxcs set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_wxcs where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_wxcs where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
